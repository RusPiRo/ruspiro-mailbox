...
all32: 
	cargo xbuild --target armv7-unknown-linux-gnueabihf --release --features ruspiro_pi3
...
all64:
	cargo xbuild --target aarch64-unknown-linux-gnu --release --features ruspiro_pi3
...
doc:
	...
	cargo doc --no-deps --target aarch64-unknown-linux-gnu --release --features ruspiro_pi3 --open
